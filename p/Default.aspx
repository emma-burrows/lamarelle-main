...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div class="row marketing">
    <div class="col-lg-6" style="padding: 10px 20px;">
      ...
      <img alt="Frog" src="../images/frog.png" style="vertical-align:top; float: left; width: 70px; height: 70px; margin: 5px; margin-right: 20px;" />
      <p>
      ...
      <p>
        <asp:LinkButton ID="fleMore" runat="server" Text="More details »" meta:resourcekey="moreInfo" CssClass="btn btn-default green" PostBackUrl="FrenchClasses.aspx"  />
      </p>
    </div>
    <div class="col-lg-6" style="padding: 10px 20px;">
      <h1 style="margin-bottom: 7px">
      ...
      <img alt="Ladybird" src="../images/Ladybird.png" style="vertical-align:top; float: left; width: 70px; height: 70px; margin: 5px; margin-right: 20px;"/>
      <p>
      ...
      <p>
        <asp:LinkButton ID="fraMore" runat="server" Text="More details »" meta:resourcekey="moreInfo" CssClass="btn btn-default purple" PostBackUrl="Classes.aspx"  />
      </p>
    </div>
  </div>
