...
public partial class en_Registration : LocalizedPage
{
  /// <summary>
  ...
  private StringBuilder getBody()
  {
    ...
    {
      sbBody.Append("<b>Téléphone:</b> " + txtTel1.Text + "<br/>");
    };
    if (!string.IsNullOrEmpty(txtTel2.Text))
    {
      sbBody.Append("<b>Téléphone:</b> " + txtTel2.Text + "<br/>");
    };
    ...
    sbBody.Append("<br/><br/><b>Commentaires:</b> " + txtComment.Text.Replace("\n", "<br/>"));
